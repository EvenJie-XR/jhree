(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('three/examples/jsm/libs/stats.module'), require('three/examples/jsm/controls/OrbitControls'), require('three/examples/jsm/controls/TrackballControls')) :
    typeof define === 'function' && define.amd ? define(['exports', 'three', 'three/examples/jsm/libs/stats.module', 'three/examples/jsm/controls/OrbitControls', 'three/examples/jsm/controls/TrackballControls'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Jhree = {}, global.three, global.Stats, global.OrbitControls, global.TrackballControls));
}(this, (function (exports, three, Stats, OrbitControls, TrackballControls) { 'use strict';
        ...
        enableStatus(enable = true, threeContainer) {
            ...
            */
            if (!this.status) { // 如果status未实例化，就先实例化，如果实例化了就直接使用，这里保持单例
                this.status = new Stats__default['default']();
            }
    ...
    class ControlsManager {
        ...
        switchOrbitControls() {
            ...
            */
            this.removeControls();
            this.controls = new OrbitControls.OrbitControls(this.jhree.camera, this.jhree.renderer.domElement);
        ...
        switchTrackballControls() {
            this.removeControls();
            this.controls = new TrackballControls.TrackballControls(this.jhree.camera, this.jhree.renderer.domElement);
            this.controls.rotateSpeed = 1.0;
            this.controls.zoomSpeed = 1.2;
            this.controls.panSpeed = 0.8;
            this._controlsHandleResizeEventRemoveCallback = this.jhree.eventManager.addEventListener(() => {
                this.controls.handleResize();
            }, exports.EventType.RESIZE);
            this._controlsUpdateEventRemoveCallback = this.jhree.eventManager.addEventListener(() => {
                this.controls?.update();
            }, exports.EventType.TICK);
        }
    ...
    class Jhree {
        ...
        constructor(threeContainer) {
            ...
            // 初始化camera的一些设置
            this.camera = new three.PerspectiveCamera(45, this.threeContainer.clientWidth / this.threeContainer.clientHeight, 0.1, 10000);
        ...
        tick() {
            ...
            this.renderer.render(this.scene, this.camera);
            this.eventManager.triggerEvent(exports.EventType.TICK);
        }
        /**
         * three场景适配container
         */
        onContainerResize() {
            ...
            */
            this.camera.updateProjectionMatrix();
            this.renderer.setSize(this.threeContainer.clientWidth, this.threeContainer.clientHeight);
            this.eventManager.triggerEvent(exports.EventType.RESIZE);
        }
    }
